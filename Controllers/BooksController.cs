...
namespace Ciurca_Radu_Lab2.Controllers
{
    public class BooksController : Controller
    {
        ...
        {
            var ciurca_Radu_Lab2Context = _context.Book.Include(b => b.Genre).Include(b => b.Author);
            return View(await ciurca_Radu_Lab2Context.ToListAsync());
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Title,Author,Price,AuthorID,GenreID")] Book book)
        {
            if (id != book.ID)
            {
                return NotFound();
